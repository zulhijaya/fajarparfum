        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tbody-td w-full">{{ $category->name }}</td>
                    <td class="tbody-td-right">
                        <x-option :first="$loop->first" :parameter="$category->id" :delete="!$category->products_count">   
                            <x-option-link route="subcategory.edit" :routedata="$category" text="Edit">
