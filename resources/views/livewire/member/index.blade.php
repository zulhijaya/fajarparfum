        ...
        <table class="w-full table-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tbody-td truncate">{{ $member->name }}</td>
                    <td class="tbody-td hidden lg:table-cell">{{ $member->phone }}</td>
                    <td class="tbody-td-right">
                        <x-option :first="$loop->first" :parameter="$member->id" :delete="false">   
                            <x-option-link route="member.edit" :routedata="$member" text="Edit">
