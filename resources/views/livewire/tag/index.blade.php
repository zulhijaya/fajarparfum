        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tbody-td w-full">{{ $tag->name }}</td>
                    <td class="tbody-td-right">
                        <x-option :first="$loop->first" :parameter="$tag->id" :delete="!$tag->perfumes">   
                            <x-option-link route="tag.edit" :routedata="$tag" text="Edit">
