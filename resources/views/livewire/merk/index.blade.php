        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tbody-td w-full">{{ $merk->name }}</td>
                    <td class="tbody-td-right">
                        <x-option :first="$loop->first" :parameter="$merk->id" :delete="!$merk->wholesale_prices_count">   
                            <x-option-link route="merk.edit" :routedata="$merk" text="Edit">
